...
<head>
    ...
    <title>Digital Incubator Plus Community Form</title>
...
<body class="bg-light">
    ...
    <div class="py-5 text-center ">
        ...
        <h2>Digital Incubator Plus Community form</h2>
        <p class="lead">Skillsrator’s Digital Incubator Plus Community Form!</p>
    </div>
    ...
    <div class="col-md-9">
        ...
        <div class="form-row">
            ...
            <input type="hidden" name="program" value="digital incubator plus community"/>
            </div>
            <div class="form-group col-md-6">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-4">
                ...
                <select id="course2" class="form-control courses" name="course2">
                            <option value="">Select Course</option>
                </select>
            </div>
            <div class="form-group col-md-4">
                <label for="course3">Course 3</label>
                <select id="course3" class="form-control courses" name="course3">
                            <option value="">Select Course</option>
                </select>
            </div>
        </div>
